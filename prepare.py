...
# download_path = "./dataset/DukeMTMC-reID/"
# download_path = "./dataset/occ_duke/"
# download_path = "./dataset/msmt17_reid/"
download_path = "./dataset/cuhk03-np-reid"
# download_path = "./dataset/market1501"
...
if "market" in download_path:
    save_path = "./dataset/Market1501_prepare/"
elif "msmt" in download_path:
    save_path = "./dataset/msmt17/"
elif "occ_duke" in download_path:
    save_path = "./dataset/occ_duke_prepare/"
elif "duke" in download_path:
    save_path = "./dataset/duke_prepare/"
elif "cuhk03-np" in download_path:
    save_path = "./dataset/cuhk03-np/"
